...
class Comparator:
    ...
    def compare(self):
        ...
        self.version_mismatch_per = (len(self.version_mismatches) / self.total_sbom_components * 100 if self.total_sbom_components else 0)
